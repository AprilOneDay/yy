    ...
    <body>
		...
		<div class="modal-body" >
			<table class="table">
				...
				<tr>
					<td>预约时间</td>
					<td><?php echo $orders['data']['time_copy']; ?></td>
				</tr>
				<tr>
					<td>医院</td>
					<td><?php echo $orders['data']['hospital']; ?></td>
				</tr>
				<tr>
					<td>预约医生</td>
					<td><?php echo $orders['data']['doctor']; ?></td>
				</tr>
				<tr>
					<td>预约科室</td>
					<td><?php echo $orders['data']['keshi']; ?></td>
				</tr>
				<tr>
					<td>家庭住址</td>
					<td><?php echo $orders['data']['address']; ?></td>
				</tr>
				<tr>
					<td>订单金额</td>
		...
		<div class="modal-footer">
			<!-- <button type="submit" class="btn btn-primary" ng-if="!loading">确定</button>
			<button type="submit" class="btn btn-primary" ng-if="loading">发货中</button> -->
		</div>
		</form>
	</body>
</div>
