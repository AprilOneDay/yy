...
?>
    ...
    <tr>
    	<th>Model</th>
        <td><input type="text" name="info[model]" id="catname" class="input-text" value="<?php echo $model;?>"></td>
    </tr>
    <tr>
    	<th>Controller</th>
        <td><input type="text" name="info[controller]" id="catname" class="input-text" value="<?php echo $controller;?>"></td>
    </tr>
    <tr>
    	<th>Action</th>
        <td><input type="text" name="info[action]" id="catname" class="input-text" value="<?php echo $action;?>"></td>
    </tr>
<tr>
...
?>  onClick="$('#show_php_ruleid').css('display','');$('#show_html_ruleid').css('display','none')"> <?php echo L('no');?>
	...
	<tr>
      ...
      <td><div id="category_php_ruleid" style="display:<?php if ($setting['ishtml']) {
    echo 'none';
}
?>">
	<?php
...
?>
	...
	<tr>
      ...
      <td><div id="show_php_ruleid" style="display:<?php if ($setting['content_ishtml']) {
    echo 'none';
}
?>">
	  <?php
...
<tr>
   ...
   <tr>
      ...
      <td><input name='setting[defaultchargepoint]' type='text' value='<?php echo $setting['defaultchargepoint'];?>' size='4' maxlength='4' style='text-align:center'> <select name="setting[paytype]"><option value="0" <?php if (!$setting['paytype']) {
    echo 'selected';
}
?>><?php echo L('readpoint');?></option><option value="1" <?php if ($setting['paytype']) {
    echo 'selected';
}
?>><?php echo L('money');?></option></select> <?php echo L('readpoint_tips');?></td>
    </tr>
    <tr>
...
<!--
	...
	<?php if (isset($setting['template_list']) && !empty($setting['template_list'])) {
